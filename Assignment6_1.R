#Assignment 6.1 / Import the Titanic Dataset from the following link:
#Download https://drive.google.com/file/d/1JTJCjdGuUxzKXYlwOavwovB01k6FWg3r/view?ts=5b42ea10
#Perform the below operations:
install.packages("tidyverse")
library(tidyverse)
install.packages("readxl")
library(readxl)
titanic3 <- read_excel("C:/Users/cynara_vere/Downloads/titanic3.xls",
...
#a. Pre-process the passenger names to come up with a list of #titles that 
